#!/usr/bin/env python3
"""
Comprehensive project cleanup and research papers audit.
"""
        ...
        for file in files:
            if file.endswith('.md'):
                ...
                try:
                    ...
                    # Check for abstract
                    if not re.search(r'## Abstract|**Abstract**', content):
...
def generate_cleanup_report(audit_results):
    ...
    print(f"Quality score: {((audit_results['total_files'] - audit_results['files_with_issues']) / audit_results['total_files'] * 100):.1f}%")
